...
<BODY>
	<FORM id=form1 name=form1 action=YHMenu.aspx method=post>
		...
		<TABLE cellSpacing=0 cellPadding=0 width=210 align=center border=0>
			<TBODY>
				<TR>
					<TD width=15 background=<%=request.getContextPath()%>/images/new_008.jpg></TD>
					<TD vAlign=top width=180 bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=3 width=165 align=center border=0>
							<TBODY>
								...
								<TR>
									<TD>
										<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="<%=request.getContextPath()%>/jsp/customer/add.jsp"
														target=main>－ 新增客户</A></TD>
												</TR>
												<TR> 
													<TD class=menuSmall><A class=style2 href="<%=request.getContextPath()%>/customer/CustomerAction_get"
								...
								<TR>
									<TD background=<%=request.getContextPath()%>/images/new_027.jpg height=1></TD>
								</TR>
								<TR>
					...
					<TD width=15 background=<%=request.getContextPath()%>/images/new_009.jpg></TD>
				</TR>
			</TBODY>
		</TABLE>
		<TABLE cellSpacing=0 cellPadding=0 width=210 align=center border=0>
			<TBODY>
				<TR>
					<TD width=15><IMG src="<%=request.getContextPath()%>/images/new_010.jpg" border=0></TD>
					<TD align=middle width=180 background=<%=request.getContextPath()%>/images/new_011.jpg
						height=15></TD>
					<TD width=15><IMG src=<%=request.getContextPath()%>/"images/new_012.jpg" border=0></TD>
				</TR>
			</TBODY>
		</TABLE>
	</FORM>
